...
- [ ] Disposition `secrets/yeti/` — NOT the AI-docs convention (contains a
  Makefile, lib/, scripts/, its own CLAUDE.md); owner decides what it is
  before anyone "migrates" it.
